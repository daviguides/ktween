package net.kawa.tween {
	...
	public class KTween {
		 ...
		 */
		static public function from(target:*, duration:Number, from:Object, ease:Function = null, callback:Function = null, delay:Number=0):KTJob {
		 ...
		 * @return			The KTween job instance.
		 */
		static public function to(target:*, duration:Number, to:Object, ease:Function = null, callback:Function = null, delay:Number=0):KTJob {
			var job:KTJob = new jobClass(target);
			job.to = to;
			job.duration = duration;
			if (ease != null) job.ease = ease;
		 ...
		 * @return			The KTween job instance.
		 */
		static public function fromTo(target:*, duration:Number, from:Object, to:Object, ease:Function = null, callback:Function = null, delay:Number=0):KTJob {
			var job:KTJob = new jobClass(target);
			job.from = from;
			job.to = to;
			job.duration = duration;
		 ...
		 */
		static public function abort(target:*=null):void {
			manager.abort(target);
		}
		 ...
		 */
		static public function cancel(target:*=null):void {
